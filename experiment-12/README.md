...
<img width="646" height="225" alt="image" src="https://github.com/user-attachments/assets/e37cbf91-7152-458d-9a07-81bde0e80d04" />

Core Kubernetes Concepts (Simple Explanation)

<img width="1075" height="227" alt="image" src="https://github.com/user-attachments/assets/58a05eaa-e2e1-4a69-9851-78badad1ab47" />
...
Step 1: Create the file ```bash wordpress-deployment.yaml ```
...
<img width="1272" height="695" alt="image" src="https://github.com/user-attachments/assets/4faa2d90-c775-4168-ab64-e9f5faf21af5" />

Step 2: Apply the deployment

```bash kubectl apply -f wordpress-deployment.yaml ```
...
Step 1: Create the file ```bash wordpress-service.yaml ```
...
```bash kubectl apply -f wordpress-service.yaml ```
...
<img width="1177" height="145" alt="image" src="https://github.com/user-attachments/assets/4cc9f6ea-5ea4-42b8-ae6d-80d037e9ceb6" />

Access WordPress in your browser:

```bash http://localhost:30007 ```

Minikube: Usually ```bash minikube ip ```

k3d: Usually ```bash localhost ```

<img width="1157" height="262" alt="image" src="https://github.com/user-attachments/assets/1fc4df71-a668-4228-8d2e-cbf55d4b1eaf" />

Task 4: Scale the Deployment

Increase the number of pods from 2 to 4:

```bash kubectl scale deployment wordpress --replicas=4 ```

<img width="1227" height="146" alt="image" src="https://github.com/user-attachments/assets/9a6c43f0-1716-4c32-8bea-9e253ef89bff" />
...
<img width="1265" height="121" alt="image" src="https://github.com/user-attachments/assets/8f8825a9-e0bf-42b9-a02a-e5bf08b66425" />

PART C – Swarm vs Kubernetes (Comparison)

<img width="582" height="227" alt="image" src="https://github.com/user-attachments/assets/9de2df15-f6f2-43c9-bee9-119713bfda3a" />
...
<img width="1240" height="497" alt="image" src="https://github.com/user-attachments/assets/b4414efc-0b88-48f0-84d7-71f426bd0b66" />
...
<img width="657" height="365" alt="image" src="https://github.com/user-attachments/assets/1a328d12-6829-40e0-a79d-73d9cef23e14" />
